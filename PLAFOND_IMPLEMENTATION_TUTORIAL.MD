...
2.  **Corporate Card Design**: Menampilkan data dalam bentuk kartu dengan *visual hierarchy* yang jelas (Header, Metrics, Footer).
...
.accent-gold { background: linear-gradient(90deg, #fef3c7, #fbbf24); }
